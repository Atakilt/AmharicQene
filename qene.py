...
def tokenize():
   ...
   if hKal == None:
      messagebox.showwarning("Error", "Sorry.Can't find 'Hibre Kal' word in wordnet")
   else:       
...
# add widgets here
window.title('የአማርኛ ቅኔ መፍቻ')
window.geometry("700x600+10+20")

# Label widgets
lblQene=Label(window, text="ቅኔ: ", fg='#14365D', font=("", 12))
lblQene.place(x=30, y=50)

# Entry widgets
txtQene=Entry(window, text="", width=65, font=('Arial 11'))
txtQene.place(x=75, y=55)
...
# Button widgets
btnQene=Button(window, text="ፍቺውን ፈልግ", fg='#14365D', font='12', command=tokenize)
btnQene.place(x=75, y=100)

btnClear=Button(window, text="አጥፋ", fg='#14365D', font='12', command=clear)
btnClear.place(x=190, y=100)

frame = Frame(window)
text_box = Text(frame, height=18, width=70, wrap=WORD)
